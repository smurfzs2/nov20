            ...
            <form action="">
                ...
                <div class="card-body">
                    <table class="table table-striped table-hover table-bordered   text-center">
                        ...
                        //    $query = "SELECT * FROM tbl_jovit INNER JOIN `hr_department` ON tbl_jovit.departmentId=hr_department.departmentId WHERE departmentName LIKE '%$hr_keyword%' and firstName LIKE '%$fname_keyword%' and lastName LIKE '%$lname_keyword%' and addressData LIKE '%$address_keyword%' and birthDate LIKE '%$bdate_keyword%' and gender LIKE '%$gender_keyword%' ORDER BY departmentName ASC";
